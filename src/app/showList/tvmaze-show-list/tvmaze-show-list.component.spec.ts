...
import { TvmazeShowListComponent } from './tvmaze-show-list.component';
...
describe('TvmazeShowListComponent', () => {
  let component: TvmazeShowListComponent;
  let fixture: ComponentFixture<TvmazeShowListComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ TvmazeShowListComponent ],
